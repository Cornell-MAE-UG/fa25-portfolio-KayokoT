...
- A safety factor of 2 for crack growth from an assumed crack of depth 0.04 in
...
- Plane Strain Fracture Toughness = 74.6 ksi-in^0.5
...
Using these selected material and geometric properties, I created a CAD model in Autodesk Fusion and then used ANSYS to model the deformation, stresses, and strains of the wrench under its maximum torque of 600 in-lbf. I clamped the drive 0.1 inches above the wrench, and applied a load of 37.5 lbs in the positive x direction, as shown below.
...
![Maximum stress, neglecting singularity]({{ "/assets/images/truemax.png" | relative_url }}){: style="width: 800px; display: block; margin: 0 auto;" }

This indicates the maximum is 53984 psi, which is 98% higher than the calculated maximum stress of 18370 psi using beam theory. This is expected as the model does not account for stress concentrations. Using this true maximum, the torque wrench has a safety factor for strength of 2.7, which is lower than the theoretical of 8.1 and too low to meet the requirement. The fatigue stress safety factor and crack growth safety factor are 1.62 and 3.48, respectively, which meet requirements but are lower than the theoretical values of 4.76 and 10.23. While I did not reiterate my design to account for this stress concentration, in practice it would be critical to either use a stronger material or reduce stress concentrations through filleting. Notably, beam theory is highly accurate away from the clamped drive; at the gauge section, the expected stress was 17,219 psi, and ANSYS predicted 17,220 psi, showing nearly zero error.
...
350 Ω half-bridge Model No. SGT-1LH/350-TY11 by DywerOmega with a carrier length of 0.362 in and height of 0.157 in would fit on the wrench and be easy to install.